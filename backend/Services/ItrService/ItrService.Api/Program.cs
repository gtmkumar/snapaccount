...
try
{
    ...
    builder.Host.UseSerilog((ctx, lc) => lc
        ...
        .WriteTo.Console()
        .Enrich.WithProperty("Service", "ItrService"));
    ...
    // SEC-011: Rate limiting — standard (100/min) + AI endpoints (20/min per user)
...
catch (Exception ex) { Log.Fatal(ex, "ItrService failed to start."); }
