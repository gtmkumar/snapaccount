...
/// <summary>
/// SEC-026: MediatR pipeline behavior that enforces RBAC permission checks for ChatService.
    ...
    where TResponse : notnull
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var unauthorizedError = Error.Unauthorized("Auth.NotAuthenticated", "Authentication is required.");
